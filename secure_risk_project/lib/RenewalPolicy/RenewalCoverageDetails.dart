...
import 'package:loginapp/RenewalPolicy/RenewalClaimsMisData.dart';
import 'package:loginapp/RenewalPolicy/RenewalEmpData.dart';
...
class RenewalCoverageDetails extends StatefulWidget {
  final GlobalKey<RenewalCoverageDetailsState>? renewalcoverageDetailsKey;
  RenewalCoverageDetails({Key? key, this.renewalcoverageDetailsKey})
      : super(key: key);
  // static final GlobalKey<RenewalCoverageDetailsState> step2Key =
  //     GlobalKey<RenewalCoverageDetailsState>();
  @override
  State<RenewalCoverageDetails> createState() => RenewalCoverageDetailsState();
  ...
  Future<void> createRenewalCoverageDetails(BuildContext context) async {
...
// Determine which radio button is selected
    ...
    if (familyDefination == 'Fixed' && SumInsureded == 'Fixed') {
      ...
      List<double> sumInsuredValues = [0.0];
    ...
    if (familyDefination == 'Varied' && SumInsureded == 'Varied') {
      data = {
        ...
        'familyDefination': familyDefination,
        'sumInsured': SumInsureded,
        "uploadFilePath": fileResponses["uploadedDocumentsPath"] ?? "",
        "empDepDataFilePath": fileResponses["EmpDepData"] ?? "",
        "mandateLetterFilePath": fileResponses["MandateLetter"] ?? "",
        "coveragesFilePath": fileResponses["CoveragesSought"] ?? "",
        "claimsMiscFilePath": fileResponses["ClaimsMis"] ?? "",
    ...
    if (familyDefination == 'Fixed' && SumInsureded == 'Fixed' ||
      ...
      data = {
        ...
        'familyDefination': familyDefination,
        'sumInsured': SumInsureded,
        "uploadFilePath": fileResponses["uploadedDocuments"] ?? "",
        "empDepDataFilePath": fileResponses["EmpDepData"] ?? "",
        "mandateLetterFilePath": fileResponses["MandateLetter"] ?? "",
        "coveragesFilePath": fileResponses["CoveragesSought"] ?? "",
        "claimsMiscFilePath": fileResponses["ClaimsMis"] ?? "",
    ...
    final url = Uri.parse(
        ApiServices.baseUrl + ApiServices.renewal_Coverage_CreateCoverage);
...
class RenewalCoverageDetailsState extends State<RenewalCoverageDetails> {
  late RenewalEmpData renewalEmpData;
  late RenewalClaimsMisData renewalClaimsMisData;
  bool _formSubmitted = false;
  bool nextClicked = false;
  bool uploadMandateText = false;
  bool uploadMandateLettererror = false;
  bool uploadClaimsMisError = false;
  // String? tpaNameFromLocalStorage;
  ...
  Future<void> fetchFieldMappings() async {
    ...
    renewalEmpData = RenewalEmpData(
        renewalcoverageDetailsKey: widget.renewalcoverageDetailsKey,
  ...
  void initState() {
    ...
    fetchFieldMappings();
    renewalClaimsMisData = RenewalClaimsMisData(
        renewalClaimsMisData: widget.renewalcoverageDetailsKey);
    getTpaNameFromLocalStorage();
  }

// bool isEmpDataUploaded
  bool validateRenewalCoverageDetails() {
  ...
  Future<void> uploadRenewalEmpdataFile(
  ...
  Future<void> uploadRenewalClaimsMis(
      Uint8List? fileBytes, String fileType, String fileName) async {
    final prefs = await SharedPreferences.getInstance();
    var headers = await ApiServices.getHeaders();
    final rfqId = prefs.getString('responseBody');
  ...
  Future<void> uploadMandateLetter(String fileType) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        //   setState(() {
        //     uploadMandateLettererror = false;
        //   });
        // }
                                      ...
                                      onChanged: (SingingCharacter? value) {
                                        setState(() {
                                          ...
                                          uploadSuccessMap["CoveragesSought"] =
                                              false;
                                          uploadSuccessMap["ClaimsMis"] = false;
                                          uploadSuccessMap["ClaimsSummary"] =
                                              false;
                            ...
                            if (uploadSuccessMap["PolicyCopy"] == true)
                              UploadedFileCard(
                                ...
                                onClose: () {
                                  // Handle card's cross mark action
                                  setState(() {
                                    uploadSuccessMap["PolicyCopy"] = false;
                                    fileResponses["PolicyCopy"] = "";
                                  });
                                },
                              ),
                            ...
                            if (uploadSuccessMap["ClaimsSummary"] == true)
                              UploadedFileCard(
                                ...
                                onClose: () {
                                  // Handle card's cross mark action
                                  setState(() {
                                    uploadSuccessMap["ClaimsSummary"] = false;
                                    fileResponses["ClaimsSummary"] = "";
                                  });
                                },
                              ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: ElevatedButton(
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: Color.fromRGBO(199,
                                                55, 125, 1.0), // Hovered color
                                            shape: RoundedRectangleBorder(
                                              borderRadius:
        ...
        Row(
          children: [
            Container(
              ...
              height: screenHeight *
                  0.8, // Height of the vertical line (adjust as needed)
