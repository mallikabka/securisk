...
class TPATemplateDataSource extends DataGridSource {
  List<TPATemplatePojo> employees;
  int rowCount;
  ...
  DataGridRowAdapter? buildRow(DataGridRow row) {
    ...
    final TPATemplatePojo rfqTemplate = insurerRow.rfqTemplate;
...
class InsurerGridRow {
  final TPATemplatePojo rfqTemplate;
