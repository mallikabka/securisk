...
class RfqDataSource extends DataGridSource {
  List<RfqTemplatePojo> employees;
  int rowCount;
  ...
  DataGridRowAdapter? buildRow(DataGridRow row) {
    ...
    final RfqTemplatePojo rfqTemplate = insurerRow.rfqTemplate;
...
class InsurerGridRow {
  final RfqTemplatePojo rfqTemplate;
