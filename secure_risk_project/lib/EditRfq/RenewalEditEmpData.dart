...
class RenewalEditEmpData {
  final GlobalKey<RenewalEditCoverState>? renewalEditCoverageDetailsStateKey;
  final List<String> empheaders;
  RenewalEditEmpData(
      {this.renewalEditCoverageDetailsStateKey, required this.empheaders});
  Future<void> renewalEdithandleUpload(
  ...
  //                             context, renewalempDataList, fileBytes, fileName);
  //                       },
  //                       child: Text(
  //                         'Failed Records - $failedRecords',
  //                         style: GoogleFonts.poppins(
  ...
  //             child: Scrollbar(
  //               child: DataTable(
  //                 headingRowHeight: SecureRiskColours.AppbarHeight,
  //                 headingRowColor: MaterialStateColor.resolveWith((states) {
  //                   return SecureRiskColours
  //                       .Table_Heading_Color; // Set your desired header background color
  //                 }),
  ...
  //       onPressed: () {
  //         renewalEditCoverageDetailsStateKey!.currentState
  //             ?.uploadEditedEmpdataFile(
  //                 fileBytes, "EmpDepData", fileName);
  //         Navigator.pop(context);
  //         ("object:checking edit renewal");
  //       },
  //       child: Text(
  //         'Upload',
