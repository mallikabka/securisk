...
class EditCover extends StatefulWidget {
  ...
  final GlobalKey<EditCoverState>? coverageDetailsKey;
  // final Uint8List fileBytes;
  EditCover({Key? key, this.coverageDetailsKey, required this.rfId})
      : super(key: key);

  @override
  State<EditCover> createState() => EditCoverState();
...
class EditCoverState extends State<EditCover> {
  late EditEmpData empData;
  ...
  Future<void> fetchFieldMappings() async {
    ...
    empData = EditEmpData(
        coverDetails1Key: widget.coverageDetailsKey,
