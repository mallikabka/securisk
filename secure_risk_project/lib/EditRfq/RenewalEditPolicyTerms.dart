...
class RenewalEditPolicyTermsDetails extends StatefulWidget {
  late String rfid;
  RenewalEditPolicyTermsDetails({super.key, required this.rfid});
  @override
  RenewalEditPolicyTermsDetailsState createState() =>
      RenewalEditPolicyTermsDetailsState();
 ...
 int index = 0;
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        toastification.showSuccess(
          ...
          title: 'EditPolicyTerms saved successfully.....!',
        );
...
class RenewalEditPolicyTermsDetailsState
    extends State<RenewalEditPolicyTermsDetails> {
  ...
  Future<void> editDataApi() async {
    ...
    try {
      ...
      for (var item in responseData) {
        ...
        rowEnabledStates.add(false);
        policyIds.add(item['id']); // Add a corresponding boolean value
      }
    } catch (e) {
      ('Error: $e');
    }
