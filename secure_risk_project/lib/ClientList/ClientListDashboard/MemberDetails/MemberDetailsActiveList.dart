...
class _ActiveListState extends State<ActiveList> {
  ...
  Future<void> _fetchData() async {
    try {
      ...
      final uploadApiUrl = Uri.parse(
              ApiServices.baseUrl + ApiServices.getAllActiveList_memberDetails)
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data.isNotEmpty) {
          ...
          setState(() {
            ...
            empCount = _masterList[1].employeeCount;
            depcount = _masterList[1].dependentCount;
            total = _masterList[1].totalCount;
          });
        } else {
  ...
  Future<void> createEmployee(
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            "${ApiServices.baseUrl}${ApiServices.createEmployeeMemberDetails}?clientListId=$clientId&productId=$productId"),
  ...
  Future<void> updateEmployee(
    ...
    final Map<String, dynamic> requestBody = {
      ...
      "relationShip": relationship,
      "gender": gender,
      "dateOfBirth": dateOfBirthController, //"1998-08-28",
      "age": int.tryParse(ageController),
      "sumInsured": sumInsured,
      "email": emailController,
      "phoneNumber": phoneNumber,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter Sum Imsured';
                                }
                                return null;
                              },
                            ),
  ...
  void _openEditDialog(int mId) {
    ...
    final TextEditingController genderController =
        TextEditingController(text: filteredData.first.gender);

    // final TextEditingController designationController =
    //     TextEditingController(text: filteredData.first.designation);

    // final TextEditingController departmentController =
    //     TextEditingController(text: filteredData.first.department);
    //    Find the department with the matching departmentName
    String departmentName = filteredData.first.department;

    Department? department1 = _departmentlist.firstWhere(
      (dept) => dept.departmentName == departmentName,
    );

    selecteddepartment = department1;
// Get the id of the department if found, or use a default value if not found
    int departmentId = department1?.id ?? -1;

    String designationName = filteredData.first.designation;

    Designation? designation1 = _designationlist.firstWhere(
      (des) => des.designationName == designationName,
    );

// Get the id of the department if found, or use a default value if not found
    int designationId = designation1?.id ?? -1;
    selecteddesignation = designation1;

    final TextEditingController roleController =
        TextEditingController(text: filteredData.first.role);
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonFormField<Designation>(
                              ...
                              //     ? selecteddesignation
                              //     : _designationlist.firstWhere(
                              //         (des) =>
                              //             des.designationName == designationName,
                              //       ),
                              value: selecteddesignation,
                              onChanged: (newValue) {
                                if (newValue != null) {
  ...
  void clearData() {
    setState(() {
      _masterList.clear(); // Clear the list of fetched data
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    // final int empCount = _masterList[1].employeeCount;
    // final int depcount = _masterList[1].dependentCount;
    // final int total = _masterList[1].totalCount;
      ...
      child: Container(
        ...
        child: Padding(
            ...
            child: Column(children: [
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButton<String>(
                            ...
                            onChanged: _handleAll, //_handleFilterByChange,
                          ...
                          for (int index = 0;
                            ...
                            DataRow(cells: [
                              ...
                              DataCell(
                                Row(
                                  children: [
                                    // Checkbox(
                                    //   value:
                                    //       false, // Provide the value of checkbox as per your requirement
                                    ...
                                    Checkbox(
                                      value:
                                          currentPageInsurers[index].isChecked,
                                      onChanged: (bool? value) {
                                        setState(() {
                                          currentPageInsurers[index].isChecked =
                                              value ?? false;
                              ...
                              DataCell(buildActionButtons(
                                  currentPageInsurers[index].memberId,
                                  currentPageInsurers[index].isChecked)),
              ...
              SizedBox(height: 5), // overlapping at bottom
              if (totalPages > 1)
                Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
  ...
  // Widget buildActionButtons(int mId, bool isChecked) {
  //   return Row(
  //     children: [
  //       IconButton(
  ...
  //         color: Colors.red,
  //         onPressed: () async {
  //           await deletePendingMemberDetails(mId.toString());
  //         },
  //       ),
  //     ],
  //   );
        ...
        IconButton(
          ...
          onPressed: () {
            if (isChecked) {
              ...
              // You may show a message or perform any other action as needed
              // For example:
              showDialog(
                context: context,
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: Text("Please select the checkbox to Edit"),
                    actions: <Widget>[
                      TextButton(
                        onPressed: () {
                          Navigator.of(context).pop();
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: Text("Please select the checkbox to delete."),
                    actions: <Widget>[
                      TextButton(
                        onPressed: () {
                          Navigator.of(context).pop();
