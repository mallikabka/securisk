...
class ManagementList extends StatefulWidget {
  int clientId;
  String productId;
  ManagementList({
    Key? key,
  ...
  @override
  State<ManagementList> createState() => _ManagementListState();
}

class _ManagementListState extends State<ManagementList> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data.isNotEmpty) {
          final List<Management> managementList = data
              .map((item) => Management(
