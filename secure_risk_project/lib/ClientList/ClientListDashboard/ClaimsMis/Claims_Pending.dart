      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data.isNotEmpty) {
          ...
          setState(() {
            ...
            _masterList = masterList
                .where((item) => item.claimStatus == 'OUTSTANDING')
                .toList();
                  ...
                  Flexible(
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(right: 10),
                          child: Text(outstandingAmount.toString(),
                          //  "0",
                            style: TextStyle(
                              color: Colors.red,
                            ),
                    ...
                    Align(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            exportClaimsMisDetails("ClaimsMisPendingList");
                          },
                          child: Container(
                            child: Row(
    ...
    if (result != null && result.files.isNotEmpty) {
      ...
      if (result.files.first.extension == 'xlsx' ||
        ...
        try {
          ...
          if (response.statusCode == 200 && tpaName == fileName) {
