...
class Claims_RejectedList extends StatefulWidget {
  int clientId;
  String productId;
  String tpaNameVar;
  Claims_RejectedList(
      ...
      : super(key: key);
  @override
  State<Claims_RejectedList> createState() => _Claims_RejectedListState();
}
...
class _Claims_RejectedListState extends State<Claims_RejectedList> {
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data.isNotEmpty) {
          ...
          setState(() {
            ...
            _masterList = masterList
                .where((item) => item.claimStatus == 'REPUDIATED')
                .toList();
                  ...
                  Flexible(
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(right: 10),
                          child: Text(repudiatedAmount.toString(),
                           // "0",
                            style: TextStyle(
                              color: Colors.red,
                            ),
                    ...
                    Align(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            exportClaimsMisDetails("ClaimsMisRejectedList");
                          },
                          child: Container(
                            child: Row(
            ...
            actions: [
              ElevatedButton(
                onPressed: () {
                  ...
                  renewalClaimsMisUpload("HealthIndia", context, "ClaimsMis");
