...
class Claims_ApprovedList extends StatefulWidget {
  int clientId;
  String productId;
  String tpaNameVar;
  Claims_ApprovedList(
      ...
      : super(key: key);
  @override
  State<Claims_ApprovedList> createState() => _Claims_ApprovedListState();
}
...
class _Claims_ApprovedListState extends State<Claims_ApprovedList> {
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data.isNotEmpty) {
          ...
          setState(() {
            ...
            _masterList = masterList
                .where((item) => item.claimStatus == 'SETTLED')
                .toList();
                  ...
                  Flexible(
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(right: 10),
                          child: Text(approvedAmount.toString(),
                          //  "0",
                            style: TextStyle(
                              color: Colors.red,
                            ),
                    ...
                    Align(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            exportClaimsMisDetails("ClaimsMisApprovedList");
                          },
                          child: Container(
                            child: Row(
