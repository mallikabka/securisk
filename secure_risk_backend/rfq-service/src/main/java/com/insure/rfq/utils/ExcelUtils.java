...
public class ExcelUtils {
    ...
    public List<EmployeeDepedentDetailsEntity> storeEmployeeDataANDfile(MultipartFile file, String fileName,
        ...
        try (Workbook workbook = WorkbookFactory.create(file.getInputStream())) {
            Sheet sheet = null;
//			if(originalFileName.equals("Alacriti")) {
...
//										.valueOf(dataRow.getCell(employeeIdColumnIndex).getNumericCellValue());
                        ...
                        if (genderColumnIndex >= 0) {
                            ...
                            if (genderCell.getCellType() == CellType.STRING) {
                                ...
                                LOG.info("Gender boolean :: " + dataRow.getCell(genderColumnIndex).getErrorCellValue());
                        ...
                        if (ageColumnIndex >= 0) {
                            ...
                            if (ageCell.getCellType() == CellType.NUMERIC) {
                                ...
                                LOG.info("Age String :: " + ageCell.getStringCellValue());
                            } else if (ageCell.getCellType() == CellType.BLANK) {
                                LOG.info("Age Blank :: ");
                            } else if (ageCell.getCellType() == CellType.BOOLEAN) {
                                LOG.info("Age String :: " + ageCell.getBooleanCellValue());
                            } else if (ageCell.getCellType() == CellType.ERROR) {
                                LOG.info("Age String :: " + ageCell.getErrorCellValue());
...
//									age = String.valueOf(ageCell.getNumericCellValue());
                        ...
                        if (dateOfBirthColumnIndex >= 0) {
                            ...
                            if (dateOfBirthCell.getCellType() == CellType.NUMERIC) {
                                ...
                                LOG.info("Date Of Birth String :: " + dateOfBirthCell.getStringCellValue());
                                ...
                                LOG.info("Date Of Birth Boolean :: " + dateOfBirthCell.getBooleanCellValue());
                            } else if (dateOfBirthCell.getCellType() == CellType.ERROR) {
                                LOG.info("Date Of Birth Error :: " + dateOfBirthCell.getErrorCellValue());
                                ...
                                switch (dateOfBirthCell.getCachedFormulaResultType()) {
                                    ...
                                    case STRING: {
                                        LOG.info("Date Of Birth String Formula :: " + dateOfBirthCell.getStringCellValue());
                                        break;
                                    }
                                    case BLANK: {
                                    ...
                                    case ERROR: {
                                        LOG.info("Date Of Birth Error Formula :: " + dateOfBirthCell.getErrorCellValue());
                                        break;
                                    }
                                    case _NONE: {
                        ...
                        if (sumInsuredColumnIndex >= 0) {
                            ...
                            if (sumInsuredCell.getCellType() == CellType.NUMERIC) {
                                ...
                                LOG.info("Sum Insured String :: " + sumInsuredCell.getStringCellValue());
                                ...
                                LOG.info("Sum Insured Boolean :: " + sumInsuredCell.getBooleanCellValue());
                            } else if (sumInsuredCell.getCellType() == CellType.ERROR) {
                                LOG.info("Sum Insured Error :: " + sumInsuredCell.getErrorCellValue());
                                ...
                                switch (sumInsuredCell.getCachedFormulaResultType()) {
                                    ...
                                    case STRING: {
                                        LOG.info("Sum Insured String Formula :: " + sumInsuredCell.getStringCellValue());
                                        break;
                                    }
                                    case BLANK: {
                                    ...
                                    case BOOLEAN: {
                                        LOG.info("Sum Insured Boolean Formula :: " + sumInsuredCell.getBooleanCellValue());
                                        break;
                                    }
                                    case ERROR: {
                                        LOG.info("Sum Insured Error Formula:: " + sumInsuredCell.getErrorCellValue());
                                        break;
                                    }
                                    case _NONE: {
                                        LOG.info("Sum Insured None");
...
//				sheet = workbook.getSheet("Claims");
                sheet = workbook.getSheetAt(0);
...
//                                System.err.println("Invalid input string: " + stringCellValue);
                            }
                        }
                    }
                }
...
//                            claimsMis.setAdmissionDate(dateOfClaimValue);
...
//                            claimsMis.setAdmissionDate(dischargeDateValue);
...
//                                System.out.println("admissionDateValue str :: " + dischargeDateValue);
//	                            claimsMis.setAdmissionDate(admissionDateValue);
                            } catch (Exception e) {
                                // Ignore or handle the exception
                            }
