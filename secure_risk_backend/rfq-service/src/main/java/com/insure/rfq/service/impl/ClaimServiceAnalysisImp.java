...
//		Optional<CorporateDetailsEntity> corporateDetailsEntityOptional =corporateDetailsRepository.findByRfqId(rfqId);
//		System.out.println(corporateDetailsEntityOptional.get().getTpaName());
//		String relationTpa="";
//		if(corporateDetailsEntityOptional.get().getTpaName().equalsIgnoreCase("HealthIndia"))
//		{
//			relationTpa="Employee";
//		}
//		else if (corporateDetailsEntityOptional.get().getTpaName().equalsIgnoreCase("FHPL")){
//			relationTpa="Employee";
//		}
//		else if (corporateDetailsEntityOptional.get().getTpaName().equalsIgnoreCase("Vipul"))
//		{
//			relationTpa="EMPLOYEE";
//		} else if (corporateDetailsEntityOptional.get().getTpaName().equalsIgnoreCase("MD India")) {
//
//			relationTpa="Employee";
//		}
		int amount=0;
...
//
//		List<ClaimsMisEntity>  ClaimsMisEntityList =analysisReportRepository.findByRfqId( rfqId);
		...
		for (String allgender : allGenderDetails) {
			...
			if(allgender.equalsIgnoreCase("Male") || allgender.equalsIgnoreCase("M")) {
				...
				double totalNumber = getPercentageCountdata(allgender, rfqId, analysisReportRepository.getCountOfGenderWise(allgender, rfqId));
				...
				double totalAmount = getPercentageAmountData(rfqId, analysisReportRepository.getGenderWiseAmountSum(allgender, rfqId));
		...
		for (String rela : relation) {
			...
			if(rela.equalsIgnoreCase("Mother")) {
				...
				relationWiseClaimReport.setCount(analysisReportRepository.getCountOfMemeberBasedOnRelation(rela, rfqId));
...
//			else if (rela.equals("Son(2)") || rela.equals("Daughter") || rela.equals("Child") || rela.equals("Son") || rela.equals("Child (2)")) {
