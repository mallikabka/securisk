...
public class SecurityConfig {
	...
	private static final String[] PERMITED_URL = { "/roles/**", "/location/**", "/user/**", "/login/**", "/tpa/**",
			"/policyType/**", "/location/**", "/api/**", "/rfq/**", "/swagger-ui.html", "/swagger-ui/**",
			"/v2/api-docs,'/rfq/intermediatrydetails/**", "/products/**", "/clientList/**" };
