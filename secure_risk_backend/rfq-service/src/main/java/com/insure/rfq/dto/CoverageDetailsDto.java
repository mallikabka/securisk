...
//	@JsonProperty(value ="empDepDataFile") 
//	MultipartFile empDepDataFile;
//	@JsonProperty(value = "mandateLetterFile")
//	MultipartFile mandateLetterFile;
//	@JsonProperty(value = "coveragesFile")
//	MultipartFile coveragesFile;
//	@JsonProperty(value = "claimsMiscFile")
//	MultipartFile claimsMiscFile;
//	@JsonProperty(value = "claimsSummaryFile")
//	MultipartFile claimsSummaryFile;
//	@JsonProperty(value = "templateFile")
//	MultipartFile templateFile;
//	@JsonProperty(value = "policyCopyFile")
//	MultipartFile policyCopyFile;
