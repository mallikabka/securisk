...
//  }
	...
	//  @GetMapping("/getCountclient/{status}")
//  public Long getRfqCountByCount(@PathVariable("status") String status) {
//     System.out.println(clientListRepository.countApplicationsByStatus(status));
//     return clientListRepository.countApplicationsByStatus(status);
//  }
