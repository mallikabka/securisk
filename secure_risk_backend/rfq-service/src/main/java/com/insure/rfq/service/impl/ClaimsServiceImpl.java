...
public class ClaimsServiceImpl implements ClaimDetailsService {
	...
	public String createClaimDetails(ClaimDetailsDto claimDetailsDto) {
		...
		System.out.println("Dto : " + claimDetailsDto);
...
//		ClaimsDetails map = modelMapper.map(claimDetailsDto,ClaimsDetails.class);
//		return modelMapper.map(claimsRepo.save(map), ClaimDetailsDto.class);
