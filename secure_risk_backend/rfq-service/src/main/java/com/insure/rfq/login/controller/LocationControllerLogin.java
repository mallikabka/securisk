...
//	public ResponseEntity<List<LocationNameUser>> getAllLocations() {
//		List<LocationNameUser> activeLocations = locationServiceImpl.listAllLocations().stream()
//				.filter(obj -> obj.getStatus().equalsIgnoreCase("active")).map(obj -> {
//					LocationNameUser locationNameUser = new LocationNameUser();
//					locationNameUser.setLocationId(obj.getLocationId());
//					locationNameUser.setSno(obj.getSno());
//					locationNameUser.setLocationName(obj.getLocationName());
////					locationNameUser.setUser(obj.getUserCount());
//					return locationNameUser;
//				}).toList();
