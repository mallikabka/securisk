...
public class ClientList_Life_PremiumCalcuaterServiceimpl implements ClientList_Life_PremiumCalcuaterService {
    ...
    @Override
    public String createClientList_Life_PremiumCalcuater(ClientList_Life_PremiumCalcuaterDto preLifePremium_Calcuater, Long clientID, Long produtId) {
        ...
        //log.info(  "   clientList is : "+ clientId + " ==="  );
    ...
    @Override
    public List<ClientList_Life_PremiumCalcuaterDto> getAllTheClientList_Life_PremiumCalcuaters(Long clientID, Long productId) {

        return liffecalcuaterRepository.findAll()
                .stream().filter(status ->
                        status.getRecordStatus().equalsIgnoreCase("ACTIVE") && status.getClientListId().getCid() == clientID && status.getProductId().getProductId().equals(productId)
                )
                .map(i -> {
                    ClientList_Life_PremiumCalcuaterDto dto = new ClientList_Life_PremiumCalcuaterDto();
                    dto.setAgeBandEnd(i.getAgeBandEnd());
    ...
    public byte[] generateExcelFromData(Long clientListId, Long productId) {
        ...
        List<ClientList_Per_Life_Premium_Calculator> activeLifePremium = liffecalcuaterRepository.findAll().
        ...
        List<ClientList> list = activeLifePremium.stream().map(ClientList_Per_Life_Premium_Calculator::getClientListId).toList();
        ...
        //List<Long> list3 = list2.stream().map(i -> i).toList();
    ...
    public ClientList_Life_PremiumCalcuaterDto update_ClientList_Life_PremiumCalcuaterDto(ClientList_Life_PremiumCalcuaterDto dto) {
