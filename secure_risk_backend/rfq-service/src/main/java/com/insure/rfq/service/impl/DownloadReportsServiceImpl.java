...
//				if (policyTermsRepositoryByRfqId.get().contains(rfqId)) {
...
//				}
				...
				if (coverageDetails1.getRfqId() != null && coverageDetails1.getClaimsMiscFilePath() != null
						&& !coverageDetails1.getClaimsMiscFilePath().trim().isEmpty()
						&& claimsMisRepositoryByRfqId.contains(rfqId)) {
...
//						String[] entryNames = { "ageBindingReport.pdf", "coverageDetailsSummary.pdf", "irdaReport.pdf",
//								"mandateLetter.pdf", "employeeData.xlsx", "claimMISC.xlsx", "clamisAnalysis.pdf" };
