...
//	@Query(value = "SELECT emp.rfqId FROM EmployeeDepedentDetailsEntity EmployeeDepedentDetailsEntityemp WHERE emp.rfqId=:id ")
//	List<String> getByrfqId(@Param("id") String id);
	...
	List<String> findAllRelationShipByRfqId(@Param("id") String rfqId);
