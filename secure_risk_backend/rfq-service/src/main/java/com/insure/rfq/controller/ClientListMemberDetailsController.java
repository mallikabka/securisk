...
public class ClientListMemberDetailsController {
    ...
    public ResponseEntity<?> createMemberDetails(@Valid @RequestParam Long clientListId,
        ...
        try {
            ...
            if (clientListMembersDetails.getMessage().contains("ClientList is not Found") || clientListMembersDetails.getMessage().contains("Product is not Found")
                    || clientListMembersDetails.getMessage().contains("Department is not Found") || clientListMembersDetails.getMessage().contains("Designation is not Found")) {
    ...
    public ResponseEntity<?> getAllMembersDetailsForMasterList(@RequestParam Long clientListId,
        ...
        try {
            List<GetAllClientListMembersDetailsDto> allClientListMembersDetails = clientListMemberDetailsService
                    .getAllClientListMembersDetails(clientListId, productId);
    ...
    public ResponseEntity<?> getAllMemberDetailsForActiveList(@RequestParam Long clientListId, @RequestParam Long productId) {
        return ResponseEntity.ok(clientListMemberDetailsService.getAllActiveListForMemberDetailsByClientListProduct(clientListId, productId));
    }
    ...
    public ResponseEntity<byte[]> getAllActiveListInExcel(@RequestParam Long clientListId,
        ...
        byte[] excelData = clientListMemberDetailsService.getActiveListInExcelFormat(clientListId,
                productId);
    ...
    public ResponseEntity<byte[]> getAllAdditionListInExcel(@RequestParam Long clientListId,
        ...
        byte[] excelData = clientListMemberDetailsService.getAdditionListInExcelFormat(clientListId,
                productId);
    ...
    public ResponseEntity<byte[]> getAllCorrectionListInExcel(@RequestParam Long clientListId,
        ...
        byte[] excelData = clientListMemberDetailsService.getCorrectionListInExcelFormat(clientListId,
                productId);
    ...
    public ResponseEntity<byte[]> getAllDeletedListInExcel(@RequestParam Long clientListId,
        ...
        byte[] excelData = clientListMemberDetailsService.getDeletedListInExcelFormat(clientListId,
                productId);
    ...
    public ResponseEntity<byte[]> getAllEnrollementListInExcel(@RequestParam Long clientListId,
        ...
        byte[] excelData = clientListMemberDetailsService.getEnrollmentListInExcelFormat(clientListId,
                productId);
    ...
    public ResponseEntity<byte[]> getAllPendingListInExcel(@RequestParam Long clientListId,
        ...
        byte[] excelData = clientListMemberDetailsService.getPendingListInExcelFormat(clientListId,
                productId);
    ...
    public ResponseEntity<?> getAllDeletedList(@RequestParam Long clientListId,
                                               @RequestParam Long productId) {
        return ResponseEntity.ok(clientListMemberDetailsService
                .getAllDeletedListForMemberDetailsByClientListProduct(clientListId, productId));
    }

    @GetMapping("/getAllCorrectionsList")
    public ResponseEntity<?> getAllCorrectionsList(@RequestParam Long clientListId,
                                                   @RequestParam Long productId) {
        return ResponseEntity.ok(clientListMemberDetailsService
                .getAllCorrectionsListForMemberDetailsByClientListProduct(clientListId, productId));
    }

    @GetMapping("/getAllAdditionList")
    public ResponseEntity<?> getAllAdditionList(@RequestParam Long clientListId,
                                                @RequestParam Long productId) {
        return ResponseEntity.ok(clientListMemberDetailsService
                .getAllAdditionListForMemberDetailsByClientListProduct(clientListId, productId));
    }
    ...
    public ResponseEntity<?> addHeadersForEnrollement(@RequestBody ClientListEnrollementHeaderMappingDto clientListEnrollementUploadDto){
        return new ResponseEntity<>(clientListEnrollementUploadService.uploadEnrollement(clientListEnrollementUploadDto),HttpStatus.CREATED);
    }

    @GetMapping("/headerValidationEnrollment")
    ...
    @GetMapping("/getEnrollmentWithStatus")
    public ResponseEntity<?> getEnrollmentWithStatus(@RequestPart MultipartFile multipartFile , @RequestParam String tpaName) {
    ...
    public ResponseEntity<?> uploadEnrollement(@RequestBody List<ClientListMemberDetailsDataStatus> clientListMemberDetailsDataStatuses,@RequestParam Long clientListId,@RequestParam Long productId) {
       return new ResponseEntity<>(clientListMemberDetailsService.uploadEnrollmentData(clientListMemberDetailsDataStatuses,clientListId,productId),HttpStatus.CREATED);
    }

    @GetMapping("/getAllclientListEnrollmentData")
    public ResponseEntity<?> getAllclientListEnrollmentData(@RequestParam Long clientListId,@RequestParam Long productId){
        return ResponseEntity.ok(clientListMemberDetailsService.getAllclientListEnrollmentData(clientListId,productId));
    }
}
