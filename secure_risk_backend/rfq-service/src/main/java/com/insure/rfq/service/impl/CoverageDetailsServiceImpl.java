...
public class CoverageDetailsServiceImpl
	...
	public String saveEmployeesFromExcel(CoverageUploadDto coverageUploadDto) {
		...
		if (coverageUploadDto.getFileType().equals("EmpData")) {
			...
			System.out.println("------  MandateLetter ----------");
			File folder = new File(mainpath);
...
//					entity.setMandateLetter(mandateLetterFileDest.getBytes());
			...
			System.out.println("------  CoveragesSought ----------");
			File folder = new File(mainpath);
			...
			if (!coverageUploadDto.getFile().isEmpty() && !CoveragesSoughtDest.exists()) {
				...
				try {
					...
					System.out.println("File converted to byte array with length: " + byteArray.length);
...
//							System.out.println(
//									" employeeIdColumnIndex :  " + dataRow.getCell(employeeIdColumnIndex).getCellType()
//											+ " " + employeeIdColumnIndex);
//							System.out.println(" employeeNameColumnIndex :  "
//									+ dataRow.getCell(employeeNameColumnIndex).getCellType() + " "
//									+ employeeNameColumnIndex);
//							System.out.println(" relationshipColumnIndex :  "
//									+ dataRow.getCell(relationshipColumnIndex).getCellType() + " "
//									+ relationshipColumnIndex);
//							System.out.println(" genderColumnIndex :  "
//									+ dataRow.getCell(genderColumnIndex).getCellType() + " " + genderColumnIndex);
//							System.out.println(" ageColumnIndex :  " + dataRow.getCell(ageColumnIndex).getCellType()
//									+ " " + ageColumnIndex);
//							System.out.println(" dateOfBirthColumnIndex :  "
//									+ dataRow.getCell(dateOfBirthColumnIndex).getCellType() + " "
//									+ dateOfBirthColumnIndex);
//							System.out.println(
//									" sumInsuredColumnIndex :  " + dataRow.getCell(sumInsuredColumnIndex).getCellType()
//											+ " " + sumInsuredColumnIndex);
...
//												Date parse = outputFormat.parse(dateOfBirth);
...
//                                            remarks = ExcelValidation.BLANK.getValue() + " DOB";
...
//                                            remarks = ExcelValidation.BOOLEAN.getValue() + " DOB";
...
//                                            remarks = ExcelValidation.NONE.getValue() + " DOB";
											...
											case STRING: {
												...
												validateDto.setDateOfBirthValidationStatus(true);
//                                                    validateDto
//                                                            .setDateOfBirthErrorMessage(ExcelValidation.OTHER.getValue());
//                                                    remarks = ExcelValidation.OTHER.getValue() + " DOB";
												break;
											}
											case BLANK: {
												validateDto.setDateOfBirthValue("");
												validateDto.setDateOfBirthValidationStatus(true);
//                                                    validateDto
//                                                            .setDateOfBirthErrorMessage(ExcelValidation.BLANK.getValue());
//                                                    remarks = ExcelValidation.BLANK.getValue() + " DOB";
												break;
											}
											case BOOLEAN: {
												...
												validateDto.setDateOfBirthValidationStatus(true);
//                                                    validateDto
//                                                            .setDateOfBirthErrorMessage(ExcelValidation.BOOLEAN.getValue());
//                                                    remarks = ExcelValidation.BOOLEAN.getValue() + " DOB";
												break;
											}
											case ERROR: {
												...
												validateDto.setDateOfBirthValidationStatus(true);
//                                                    validateDto
//                                                            .setDateOfBirthErrorMessage(ExcelValidation.ERROR.getValue());
//                                                    remarks = ExcelValidation.ERROR.getValue() + " DOB";
												break;
											}
											case _NONE: {
...
//                sheet = workbook.getSheetAt(0);
			...
			for (String fileName : dataToEmail.getDocumentList()) {
				...
				if (fileName.equalsIgnoreCase("IRDA Details")) {
					...
					if (!corporateDetailsEntity.isEmpty()) {
						...
						// String outputFilePath = rfqIrdaPath;
	...
	public String uploadFileCoverage(CoverageUploadDto coverageUploadDto) {
		...
		if (coverageUploadDto.getFileType().equals("EmpDepData")) {
			...
			List<ClaimsMisEntity> saveAll = claimsMisRepo.saveAll(claimsMisData);
...
//			System.out.println("------  ClaimsMis ----------");
			...
			System.out.println("------  ClaimsSummary ----------");
			File folder = new File(mainpath);
