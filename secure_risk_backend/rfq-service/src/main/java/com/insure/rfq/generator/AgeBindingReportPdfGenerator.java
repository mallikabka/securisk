    ...
    public byte[] generatePdf(CoverageDetailsDto coverageDetails) throws IOException, DocumentException {
        ...
        if (coverageDetails.isFamilyDefication13()) {
            ...
            for (Map.Entry<Double, List<EmployeeDepedentDetailsEntity>> entry : groupedBySumInsured.entrySet()) {
                ...
                pageHeading2.setAlignment(Paragraph.ALIGN_CENTER);
...
//                    if (count==count1){
                    ...
                    pageHeading.setAlignment(Paragraph.ALIGN_CENTER);
                    ...
                    pageHeading1.setAlignment(Paragraph.ALIGN_CENTER);
...
//                }
                    ...
                    Paragraph mainHeading1 = new Paragraph(" Sum Insured : " + sumInsuredValue + " :: 1+3",
                            boldBlueFonts);
                    mainHeading1.setAlignment(Paragraph.ALIGN_CENTER);
                    document.add(mainHeading1);
                    Paragraph pageHeading22 = new Paragraph(" ");
                    pageHeading22.setAlignment(Paragraph.ALIGN_CENTER);
...
//                    }
                    ...
                    pageHeading4.setAlignment(Paragraph.ALIGN_CENTER);
        ...
        // Add a new page based on familyDeficationParents
//		if (coverageDetails.isFamilyDeficationParents()) {
//			int count3 = 0;
//
//			for (Map.Entry<Double, List<EmployeeDepedentDetailsEntity>> entry : groupedBySumInsured.entrySet()) {
//				Double sumInsuredValue = entry.getKey();
...
//				pageHeading2.setAlignment(Paragraph.ALIGN_CENTER);
//				document.add(pageHeading2);
//				if (isParentsOnly(sumInsuredGroup, id, golbalEmployeeDetailsBasedOnRfqId)) {
//					count3++;
//
//					if (count == count3) {
//						if (coverageDetails.isFamilyDefication13()
//								|| coverageDetails.isFamilyDefication15() && onePlusThree || onePlusFive) {
////							document.newPage();
//							if (pageCount % 3 == 0) {
//								document.newPage();
//							}
//						}
//
//						Paragraph pageHeading223 = new Paragraph("Family Defination Parents Only", boldBlueFont);
//						pageHeading223.setAlignment(Paragraph.ALIGN_CENTER);
//						document.add(pageHeading223);
//						Paragraph mainHeading224 = new Paragraph("RFQ ANALYSIS", boldBlueFont);
//						mainHeading224.setAlignment(Paragraph.ALIGN_CENTER);
//						document.add(mainHeading224);
//						Paragraph pageHeading123 = new Paragraph(" ");
//						pageHeading123.setAlignment(Paragraph.ALIGN_CENTER);
//						document.add(pageHeading123);
//
//						// Add a table for familyDefication13Amount
//						PdfPTable table123 = new PdfPTable(2);
//						table123.setWidthPercentage(100);
//						table123.setWidthPercentage(100);
//						table123.addCell(createCenteredCell("AnalysisName"));
//						table123.addCell(createCenteredCell("Count"));
...
//					// Add a table for familyDefication13Amount
//
//					// Add rows for Self, Spouse, and Childrens
//
//					Set<String> employeesWithParents = getAllSetOfRelationOfOnePlusFive(id);
//
//					Paragraph mainHeading1 = new Paragraph(" Sum Insured : " + sumInsuredValue + " :: Parents Only ",
//							boldBlueFonts);
//					mainHeading1.setAlignment(Paragraph.ALIGN_CENTER);
//
//					document.add(mainHeading1);
...
//					pageHeading22.setAlignment(Paragraph.ALIGN_CENTER);
//					document.add(pageHeading22);
//					PdfPTable table23 = new PdfPTable(10);
//					table23.setWidthPercentage(100);
//					table23.addCell(createCenteredCell("Age"));
//					table23.addCell(createCenteredCell("0-25"));
//					table23.addCell(createCenteredCell("26-35"));
//					table23.addCell(createCenteredCell("36-45"));
//					table23.addCell(createCenteredCell("46-55"));
//					table23.addCell(createCenteredCell("56-65"));
//					table23.addCell(createCenteredCell("66-75"));
//					table23.addCell(createCenteredCell("75-85"));
//					table23.addCell(createCenteredCell(">85"));
//					table23.addCell(createCenteredCell("Total"));
//
...
//					table3.setWidthPercentage(100);
//
//					int countOfEmployeesByAgeRangeBetween0to25 = ageBindingData.getCountOfDataOfParentsOnly(id, "Emp",
//							0, 25.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 0, 25.5, sumInsuredValue,
//									golbalEmployeeDetailsBasedOnRfqId);
//
//					int countOfEmployeesByAgeRangeBetween26to35 = ageBindingData.getCountOfDataOfParentsOnly(id, "Emp",
//							25.500000000001, 35.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 25.500000000001, 35.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//
//					int countOfEmployeesByAgeRangeBetween36to45 = ageBindingData.getCountOfDataOfParentsOnly(id, "Emp",
//							35.500000000001, 45.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 35.500000000001, 45.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//
//					int countOfEmployeesByAgeRangeBetween46to55 = ageBindingData.getCountOfDataOfParentsOnly(id, "Emp",
//							45.500000000001, 55.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 45.500000000001, 55.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//
//					int countOfEmployeesByAgeRangeBetween56to65 = ageBindingData.getCountOfDataOfParentsOnly(id, "Emp",
//							55.500000000001, 65.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 55.500000000001, 65.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//
//					int countOfEmployeesByAgeRangeBetween66to75 = ageBindingData.getCountOfDataOfParentsOnly(id, "Emp",
//							65.500000000001, 75.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 65.500000000001, 75.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//
//					int countOfEmployeesByAgeRangeBetween76to85 = ageBindingData.getCountOfDataOfParentsOnly(id, "Emp",
//							75.500000000001, 85.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 75.500000000001, 85.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangeBetweenmoreThan85 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Emp", 85.500000000001, 150, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "self", 85.500000000001, 150,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//
//					int total_self = countOfEmployeesByAgeRangeBetween0to25 + countOfEmployeesByAgeRangeBetween26to35
//							+ countOfEmployeesByAgeRangeBetween36to45 + countOfEmployeesByAgeRangeBetween46to55
//							+ countOfEmployeesByAgeRangeBetween56to65 + countOfEmployeesByAgeRangeBetween66to75
//							+ countOfEmployeesByAgeRangeBetween76to85 + countOfEmployeesByAgeRangeBetweenmoreThan85;
//					table3.addCell(createCenteredCell("Self"));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetween0to25 + ""));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetween26to35 + ""));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetween36to45 + ""));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetween46to55 + ""));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetween56to65 + ""));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetween66to75 + ""));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetween76to85 + ""));
//					table3.addCell(createCell(countOfEmployeesByAgeRangeBetweenmoreThan85 + ""));
//					table3.addCell(createCell(total_self + ""));
//					document.add(table3);
//
//					int countOfEmployeesByAgeRangesParents_0to25 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 0, 25.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 0, 25.5, sumInsuredValue,
//									golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 0, 25.5, sumInsuredValue,
//									golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangesParents_26to35 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 25.500000000001, 35.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 25.500000000001, 35.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 25.500000000001, 35.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangesParents_36to45 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 35.500000000001, 45.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 35.500000000001, 45.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 35.500000000001, 45.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangesParents_46to55 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 45.500000000001, 55.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 45.500000000001, 55.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 45.500000000001, 55.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangesParents_56to65 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 55.500000000001, 65.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 55.500000000001, 65.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 55.500000000001, 65.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangesParents_66to75 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 65.500000000001, 75.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 65.500000000001, 75.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 65.500000000001, 75.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangesParents_76to85 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 75.500000000001, 85.5, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 75.500000000001, 85.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 75.500000000001, 85.5,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int countOfEmployeesByAgeRangesParentsMoreThan85 = ageBindingData.getCountOfDataOfParentsOnly(id,
//							"Mother", 85.500000000001, 150, sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Father", 85.500000000001, 150,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId)
//							+ ageBindingData.getCountOfDataOfParentsOnly(id, "Parent", 85.500000000001, 150,
//									sumInsuredValue, golbalEmployeeDetailsBasedOnRfqId);
//					int totalage_parents = countOfEmployeesByAgeRangesParents_0to25
//							+ countOfEmployeesByAgeRangesParents_26to35 + countOfEmployeesByAgeRangesParents_36to45
//							+ countOfEmployeesByAgeRangesParents_46to55 + countOfEmployeesByAgeRangesParents_56to65
//							+ countOfEmployeesByAgeRangesParents_66to75 + countOfEmployeesByAgeRangesParents_76to85
//							+ countOfEmployeesByAgeRangesParentsMoreThan85;
//					PdfPTable table6 = new PdfPTable(10);
//					table6.setWidthPercentage(100);
//					table6.addCell(createCenteredCell("Parents"));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParents_0to25 + ""));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParents_26to35 + ""));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParents_36to45 + ""));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParents_46to55 + ""));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParents_56to65 + ""));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParents_66to75 + ""));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParents_76to85 + ""));
//					table6.addCell(createCell(countOfEmployeesByAgeRangesParentsMoreThan85 + ""));
//					table6.addCell(createCell(totalage_parents + ""));
//					document.add(table6);
//
//					int total_0_25_1_5 = countOfEmployeesByAgeRangeBetween0to25
//							+ countOfEmployeesByAgeRangesParents_0to25;
//					int total_26_35_1_5 = countOfEmployeesByAgeRangeBetween26to35
//							+ countOfEmployeesByAgeRangesParents_26to35;
//					int total_36_45_1_5 = countOfEmployeesByAgeRangeBetween36to45
//							+ countOfEmployeesByAgeRangesParents_36to45;
//					int total_46_55_1_5 = countOfEmployeesByAgeRangeBetween46to55
//							+ countOfEmployeesByAgeRangesParents_46to55;
//					int total_56_65_1_5 = countOfEmployeesByAgeRangeBetween56to65
//							+ countOfEmployeesByAgeRangesParents_56to65;
//					int total_66_75_1_5 = countOfEmployeesByAgeRangeBetween66to75
//							+ countOfEmployeesByAgeRangesParents_66to75;
//					int total_76_85_1_5 = countOfEmployeesByAgeRangeBetween76to85
//							+ countOfEmployeesByAgeRangesParents_76to85;
//					int totalMoreThan85 = countOfEmployeesByAgeRangeBetweenmoreThan85
//							+ countOfEmployeesByAgeRangesParentsMoreThan85;
//
//					int total_1_5 = total_0_25_1_5 + total_26_35_1_5 + total_36_45_1_5 + total_46_55_1_5
//							+ total_56_65_1_5 + total_66_75_1_5 + total_76_85_1_5 + totalMoreThan85;
//
//					PdfPTable table7 = new PdfPTable(10);
//					table7.setWidthPercentage(100);
//					table7.addCell(createCenteredCell("Total"));
...
//					table7.addCell(createCell(total_66_75_1_5 + ""));
//					table7.addCell(createCell(total_76_85_1_5 + ""));
//					table7.addCell(createCell(totalMoreThan85 + ""));
//					table7.addCell(createCell(total_1_5 + ""));
//
//					document.add(table7);
//				}
            ...
            if (coverageDetails.isFamilyDefication13()
                ...
                for (Map.Entry<Double, List<EmployeeDepedentDetailsEntity>> entry : groupedBySumInsured.entrySet()) {
                    ...
                    if (isOnePlusThree(sumInsuredGroup, id, golbalEmployeeDetailsBasedOnRfqId)) {
                        ...
                        pageHeading12.setAlignment(Paragraph.ALIGN_CENTER);
...
//		for (String employeeId : ageBindingData.onePlusFive(golbalEmployeeDetailsBasedOnRfqId)) {
...
//	public boolean isParentsOnly(List<EmployeeDepedentDetailsEntity> sumInsuredGroup, String rfqId,
//			List<EmployeeDepedentDetailsEntity> golbalEmployeeDetailsBasedOnRfqId) {
//		for (String employeeId : ageBindingData.getAllSetOfRelationOfParentsOnly(golbalEmployeeDetailsBasedOnRfqId)) {
//			if (sumInsuredGroup.stream().anyMatch(entity -> entity.getEmployeeId().equals(employeeId))) {
//				return true;
//			}
//		}
...
//	}
    ...
    public List<AgeBindingRatioAnalysisDto> getMaleAndFemaleRatios(
        ...
        int totalEmployeeCount = depedentDetailsEntities.stream()
                ...
                .filter(entity -> entity.getRelationship().trim().matches(selfRegExp)).collect(Collectors.toList())
                .size();
        ...
        int totalSpouseCount = depedentDetailsEntities.stream()
                ...
                .filter(entity -> entity.getRelationship().trim().matches(spouseRegExp)).collect(Collectors.toList())
                .size();

        int totalChildCount = depedentDetailsEntities.stream()
                .filter(entity -> entity.getSumInsured() == sumInsured && entity.getRfqId().equalsIgnoreCase(rfqId)
                        && employeeIds.contains(entity.getEmployeeId()))
                .filter(entity -> entity.getRelationship().trim().matches(childRegExp)).collect(Collectors.toList())
                .size();

        int totalParentCount = depedentDetailsEntities.stream()
                .filter(entity -> entity.getSumInsured() == sumInsured && entity.getRfqId().equalsIgnoreCase(rfqId)
                        && employeeIds.contains(entity.getEmployeeId()))
                .filter(entity -> entity.getRelationship().trim().matches(parentRegExp)).collect(Collectors.toList())
                .size();
